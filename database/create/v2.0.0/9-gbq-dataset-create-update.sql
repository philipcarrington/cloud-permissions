drop view permissions_meta.gbq_dataset_create_update_commands_command_line
go
create view permissions_meta.gbq_dataset_create_update_commands_command_line as (
with 
    constants as (
    ...
    dataset_data_base as (
        ...
        */
        select distinct
               ...
               lower(concat(edd.e_given_name, '.', edd.e_family_name, '@', odted.o_organisation_email_domain)) as permissions_email_override,              
               odted.o_organisation_email_domain as organisation_email_domain
...
drop view permissions_meta.gbq_dataset_create_update_commands_python
go
create view permissions_meta.gbq_dataset_create_update_commands_python as (
    with     
        dataset_data_base as (
            /*
                Organistaion Department Team:
        ...
        dataset_data as (
            select ddb.internal_google_cloud_project_id,
                   ...
                   ddb.internal_google_bigquery_dataset_id,
                   ddb.google_bigquery_dataset_name,
                   ddb.google_cloud_location_name,
                   ddb.google_bigquery_dataset_default_table_expiration,
                   ddb.google_bigquery_dataset_default_partition_expiration,
                   ddb.google_bigquery_dataset_short_description,
                   ddb.role_type,
                   ddb.permission_type,
                   concat(
